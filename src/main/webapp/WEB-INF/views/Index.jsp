...
<html>
    ...
    <script type="text/javascript">function cl() {
	$.cookie('thekey', 'the value');
}
    function reloadcode() {
    	canflush=true;
    					...
    					<div class="col-sm-4 col-sm-offset-4">
    						...
    						<div class="form-bottom">
    							<form id="loginform">
    								...
    								<button type="submit" onclick="cl()" class="btn btn-info btn-lg btn-block submit-holder">登录</button>
    							</form>
    						</div>
